  ...
  return (
    <div className="-mt-16">
      <img
          src={image.url}
          alt={`${name} icon`}
          className="h-32 mx-auto relative top-16"
      />

      <div className="bg-gray box-border pt-8 px-10 pb-6 rounded-lg">
        ...
        <ButtonLink variant="tertiary" to={`/categories/${slug}`} className="justify-center !py-0">
          Shop
        </ButtonLink>
      </div>
    </div>
